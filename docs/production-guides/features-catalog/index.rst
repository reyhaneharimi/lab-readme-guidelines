...
.. _capacity-and-scalability:

ویژگی‌های ظرفیت و مقیاس‌پذیری
------------------------------
...
.. _lifecycle-and-environment-management:

ویژگی‌های چرخه حیات و مدیریت WorkshopEnvironment / Session
------------------------------------------------------------
...
.. _security-rbac-isolation:

امنیت، RBAC و ایزولاسیون
-------------------------
...
.. _technical-limitations:

محدودیت‌های فنی و چالش‌های عملیاتی
------------------------------------
...
.. _portal-access-control:

کنترل دسترسی و تجربه کاربری پورتال
------------------------------------
...
.. _ingress-hostname-iframe-cookies:

Ingress / Hostname / Iframe / Cookies
--------------------------------------
...
ضمیمه: الگوهای Use Case محور (با YAML)
----------------------------------------
